...
#define COPY_RENAME_DEVICE_SERVICE_UUID(uuid_struct)    COPY_UUID_128(uuid_struct,0x00,0x00,0x00,0x00,0x00,0x03,0x11,0xe1,0x9a,0xb4,0x00,0x02,0xa5,0xd5,0xc5,0x1b)
#define COPY_RENAME_DEVICE_CHAR_UUID(uuid_struct)       COPY_UUID_128(uuid_struct,0x00,0x01,0x00,0x00,0x00,0x03,0x11,0xe1,0x9a,0xb4,0x00,0x02,0xa5,0xd5,0xc5,0x1b)



uint16_t HWServW2STHandle, AccGyroMagCharHandle; //EnvironmentalCharHandle, ;
//uint16_t SWServW2STHandle, QuaternionsCharHandle;
uint16_t RenameDeviceServiceHandle, RenameDeviceCharHandle;
...
/**
 * @brief  Write Request Callback for Rename Device characteristic.
 * @param  handle The handle of the characteristic to update.
 * @param  data Pointer to the data written (the new name).
 * @param  length Length of the written data.
 * @retval None.
 */
